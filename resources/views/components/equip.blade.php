    ...
    <div class="card__body space-y-4">
        ...
        @if ($escut)
            <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-900/50 rounded-2xl">
                ...
                <div>
                    <p class="text-xs text-slate-400 uppercase font-bold tracking-wider m-0">{{ __('Escut') }}</p>
                    <img src="{{ asset('storage/' . $escut) }}" alt="{{ $nom }}" class="text-lg font-semibold m-0" width="100" height="100">
                </div>
            </div>
        @endif
    </div>
